...
In short, we rely on the AR6 land regions provided through the regionmask package and work with area-weighted regional averages if not states otherwise.